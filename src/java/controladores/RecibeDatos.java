...
public class RecibeDatos extends HttpServlet {
     ...
     * @throws IOException if an I/O error occurs
     */
    @Override //el metodo post no usa el url para transmitir los parametros (el get si) los envia dentro del paquete http
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String password= request.getParameter("Contraseña");
            ...
            if("admin".equals(user) && "1234".equals(password)){
                ...
                processRequest(request, response, "Ingreso inválido");
            }
    }
